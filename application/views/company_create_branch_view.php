                    ...
                    <div class="panel-body profile-information">
                        <div class="col-md-6">
                            <div class="form-group" style="display: none;">
                                ...
                                ?>
                                <input class="form-control" id="company_name" value="<?php echo $company_name;?>">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Street</label>
                                <input class="form-control" id="branch_street">
                            </div>
                            <div class="form-group">
                                <label>Country</label>
                                <input class="form-control" id="branch_country">
                            </div>
                            <div class="form-group">
                                <label>City</label>
                                <input class="form-control" id="branch_city">
                            </div>
                            <div class="form-group">
                                <label>Zip Code</label>
                                <input class="form-control" id="branch_zipcode">
                            </div>
                            <div class="form-group">
                                <label>Building</label>
                                <input class="form-control" id="branch_building">
                            </div>
                            <div class="form-group">
                                <label>Unit</label>
                                <input class="form-control" id="branch_unit">
                            </div>
                            <div class="form-group">
                                <button id="create-branch-btn" class="btn btn-primary">Submit</button>
                                <a href="<?php echo base_url();?>index.php/company/branch_management" id="cancel-branch-btn" class="btn btn-warning">Cancel</a>
                            </div>
                        </div>
                    </div>
                </section>
