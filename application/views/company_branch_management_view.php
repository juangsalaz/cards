                ...
                <section class="panel">
                    ...
                    <div class="panel-body profile-information">
                        <div class="form-group">
                            <a href="<?php echo base_url();?>index.php/company/create_branch" class="btn btn-primary">Create New Branch</a>
                        </div>
                        <?php 
                            $company_name = str_replace('%20', ' ', $this->session->userdata('company_name'));
                        ?>
                        <input type="hidden" id="get-branch-company-name" value="<?php echo $company_name;?>">
                        <div class="col-md-12">
                            <table id="branch-list-table" class="display table table-bordered table-striped"></table>
                        </div>
                    </div>
                </section>
            </div>
...
<script>
var $table = $('#branch-list-table');
var company_name = $("#get-branch-company-name").val();
$table.bootstrapTable({
    url: "get_branch_list/"+company_name,
    search: true,
    pagination: true,
    sortOrder: 'desc',
    ...
    columns: [
        ...
        {
            field: 'branch_building',
            title: 'Building',
            sortable: true,
        },
        {
            field: 'branch_zipcode',
            title: 'Zip Code',
        },
        {
            field: 'branch_city',
