                ...
                <section class="panel">
                    ...
                    <div class="panel-body profile-information">
                            ...
                            <div class="form-inline">
                                <div class="form-group">
                                    <?php
                                        ...
                                        $branch_name = str_replace('%20', ' ', $branch_name);

                                    ?>
                                    <input type="hidden" id="new-staff-company" class="form-control" style="width: 300px;" value="<?php echo $company_name;?>">
                                    <input type="hidden" id="branch_name" class="form-control" style="width: 300px;" value="<?php echo $branch_name;?>">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="col-md-6">
                                <table id="staff-list-table" class="display table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Email</th>
                                            <th>Name</th>
...
//     url: "get_staff_list_choose_page/"+company_name,
//     search: true,
//     pagination: true,
//     sortOrder: 'desc',
//     sortName: 'name',
